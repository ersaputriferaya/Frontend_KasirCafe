...
export default class Header extends React.Component {
    ...
    render() {
        return (
            <header class="header bg-white shadow py-4 px-4" style={{ backgroundColor: "rgb(184, 231, 225)" }}>
                <div class="header-content flex items-center flex-row">
                    <form action="#">
                        <div class="hidden md:flex relative">
                        <h1 class="font-bold text-2xl text-gray-700" style={{ color: "rgb(158, 111, 33)" }}>Dashboard</h1>
                        </div> 
