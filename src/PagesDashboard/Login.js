            ...
            <div className="dashboard1">
                <section>
                    <div className="px-4 py-12 mx-auto max-w-7xl sm:px-6 md:px-12 lg:px-24 lg:py-24">
                        <div className="justify-center mx-auto text-left align-bottom transition-all transform bg-white rounded-lg sm:align-middle sm:max-w-2xl sm:w-full" style={{ backgroundColor: "rgb(248, 232, 238)", marginTop: "35px"}}>
                            <div className="grid flex-wrap items-center justify-center grid-cols-1 mx-auto shadow-xl lg:grid-cols-2 rounded-xl">
                                <div className="w-full px-6 py-3">
                                    <div>
                                        <div className="mt-3 text-left sm:mt-5">
                                            <div className="inline-flex items-center w-full">
                                                <h3 className="text-lg font-bold text-neutral-600 leading-6 lg:text-4xl">Selamat Datang!</h3>
                                            </div>
                                            <div className="mt-4 text-base text-gray-500">
                                                <p>Wikusama crepe cake cafe</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <form onSubmit={this.handleLogin}>
                                        <div className="mt-6 space-y-2">
                                            ...
                                            <div className="flex flex-col mt-4 lg:space-y-2">
                                                <button type="submit" name="login" className="flex items-center justify-center w-full px-10 py-4 text-base font-medium text-center text-white transition duration-500 ease-in-out transform bg-blue-600 rounded-xl hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500" style={{ backgroundColor: "rgb(242, 190, 209)" }}>Log In</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                <div className="order-first hidden w-full lg:block">
                                    <img className="object-cover h-full bg-cover rounded-l-lg" src="../assets/logo_cafe.png" alt="" />
                                </div>
                            </div>
                        </div>
                    </div>
