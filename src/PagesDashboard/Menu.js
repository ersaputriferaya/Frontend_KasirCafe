...
export default class Menu extends React.Component {
    ...
    handleSave = (e) => {
        ...
        if (this.state.action === "insert") {
            ...
            let url = "http://localhost:8000/menu/" + this.state.id
                ...
                <main class="main flex flex-col flex-grow -ml-64 md:ml-0 transition-all duration-150 ease-in">
                    ...
                    <footer class="footer px-4 py-2">
                        <div class="footer-content">
                            <p class="text-sm text-gray-600 text-center">© Brandname 2023. All rights reserved. <a href="https://twitter.com/iaminos">by Me</a></p>
                        </div>
                    </footer>
                </main >
                    ...
                    <div class="flex lg:h-auto w-auto justify-center ">
                        <div class="relative bg-white rounded-lg shadow dark:bg-white w-1/3">
                            ...
                            <div class="px-6 py-6 lg:px-8">
                                <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-black">Edit Menu</h3>
