...
export default class HitoryTransaksi extends React.Component {
  ...
  handleSave = (e) => {
    ...
    if (this.state.action === "insert") {
      ...
      let url = "http://localhost:8000/transaksi/" + this.state.id;
      axios
  ...
  getTransaksi = () => {
    let url = "http://localhost:8000/transaksi/getAll";
